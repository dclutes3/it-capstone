    ...
    <body>
        ...
        <div class="text-center">
		    ...
		    <div class="mb-5"></div>
                    ...
                    <a class="btn btn-primary" href="storeItems.php?Id=1">View Items</a>
                </div>
                <div class="col-lg-4 mb-5">
		    <div class="mb-5"></div>
                    <h1 style="font-size: 60px; font-weight: bold; color: deepskyblue;">Walmart</h1>
                    <a class="btn btn-primary" href="storeItems.php?Id=2">View Items</a>
                </div>
                <div class="col-lg-4 mb-5">
		    <div class="mb-5"></div>
                    <h1 style="font-size: 60px; font-weight: bold; color: darkblue;">Aldi</h1>
                    <a class="btn btn-primary" href="storeItems.php?Id=3">View Items</a>
                </div>
            </div>
        </div>
        <!-- End Featured Area -->
